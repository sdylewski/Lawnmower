...
# big motor driver:
BladeEN = Pin(22, Pin.OUT) # Enable, Red, L_EN
BladeRPWM = PWM(Pin(26)) # Green
BladeLPWM = PWM(Pin(27)) # Yellow

DirectionReverse = False
SteeringReverse = True
...
# Initialize PWM
for pwm in [Front_pwmA, Front_pwmB, Rear_pwmA, Rear_pwmB, BladeLPWM, BladeRPWM]:
    pwm.freq(1000)
...
while True:
    ...
    rcCH6, rawCH6 = read_channel(CH6, 0, 255, 0) # dial
...
# todo:
# motor smoothing when switch is turned on and BladeDuty is high
    # check if switch is on:
    if rcCH5 == True :
        # convert 0-100 ch6 value to 16 bit:
        BladeDuty = int(min(max(rcCH6, 0), 255) * 65535 / 255)
        # forward?:
        #BladeRPWM.duty_u16(BladeDuty)
        #BladeLPWM.duty_u16(0)
        # reverse?
        BladeRPWM.duty_u16(0)
        BladeLPWM.duty_u16(BladeDuty)
        BladeEN.high()
    else:
        BladeDuty = int(0)
        BladeEN.low()
...
#     else:  # Normal Mode
    ...
    if rcCH2 > 0:
        print(timestamp, "RAW  CH1:", rawCH1, "CH2:", rawCH2, "CH3:", rawCH3, "CH4:", rawCH4, "CH5:", rawCH5, "CH6:", rawCH6, "Blade:", BladeDuty)
        print(timestamp, "NORM CH1:", rcCH1, "CH2:", rcCH2, "CH3:", rcCH3, "CH4:", rcCH4, "CH6:",rcCH6, " Motor A Speed:", MotorSpeedA, " B Speed:", MotorSpeedB, " Forward" )
    elif rcCH2 < 0:
        print(timestamp, "RAW  CH1:", rawCH1, "CH2:", rawCH2, "CH3:", rawCH3, "CH4:", rawCH4, "CH5:", rawCH5, "CH6:", rawCH6, "Blade:", BladeDuty)
        print(timestamp, "NORM CH1:", rcCH1, "CH2:", rcCH2, "CH3:", rcCH3, "CH4:", rcCH4, "CH6:",rcCH6, " Motor A Speed:", MotorSpeedA, " B Speed:", MotorSpeedB, " Reverse" )
    else :
        print(timestamp, "RAW  CH1:", rawCH1, "CH2:", rawCH2, "CH3:", rawCH3, "CH4:", rawCH4, "CH5:", rawCH5, "CH6:", rawCH6, "Blade:", BladeDuty)
        print(timestamp, "NORM CH1:", rcCH1, "CH2:", rcCH2, "CH3:", rcCH3, "CH4:", rcCH4, "CH6:",rcCH6, " Motor A Speed:", MotorSpeedA, " B Speed:", MotorSpeedB, " Stopped" )
